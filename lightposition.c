...
screen_reshape(int width, int height)
{
	...
	if (swapped) {
		exlightfv(GL_LIGHT0, GL_POSITION, pos);
		exlookat(lookat[0].value, lookat[1].value, lookat[2].value,
...
command_display(void)
{
	...
	if (swapped)
		drawstr(30, 80, "exlightfv(GL_LIGHT0, GL_POSITION, pos);");
	else
		drawstr(30, 200, "exlightfv(GL_LIGHT0, GL_POSITION, pos);");
...
main(int argc, char** argv)
{
	...
	command = glutCreateSubWindow(window, GAP + 256 + GAP, GAP + 256 + GAP, 256,
	    256);
